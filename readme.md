...
- Можно изменить количество паралелльных браузеров для парсинга (по умолчанию 10) (пункт NUM_PARALLEL_BROWSERS), значит 10 страниц будут парситься одновременно учтите что на **8ГБ RAM** - **10 браузеров** будет работать на около **80% загруженности**
...
- Работа в нескольких браузерах в *8 браузерах для парсинга каждых 8 страниц авито и циана по очереди*
